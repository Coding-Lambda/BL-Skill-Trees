/*
 * Special adjustments:
 * - Commented out SVG related stuff for as long we don't use it
 * - Added "this" as RenderableProps ref type in Component base class
 *
 */
...
declare namespace preact {
    ...
    type RenderableProps<P, RefType> = Readonly<
        P & Attributes & { children?: ComponentChildren; ref?: Ref<RefType> }
        >;

    interface FunctionalComponent<PropsType = {}> {
        (props: RenderableProps<PropsType, any>, context?: any): VNode<any> | null;
        displayName?: string;
    ...
    abstract class Component<PropsType, StateType> {
        ...
        props: RenderableProps<PropsType, this>;
        context: any;
        base?: HTMLElement;
        ...
        abstract render(props?: RenderableProps<PropsType, this>, state?: Readonly<StateType>, context?: any): ComponentChild;
    }
